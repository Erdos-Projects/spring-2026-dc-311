...
#     # Smoke test: Ward 1 approximate centroid, short window
#     TEST_LAT = 38.9163
#     TEST_LON = -77.0369
#     print(f"Fetching hourly weather for ({TEST_LAT}, {TEST_LON}) ...")
#     df_h = get_hourly_weather(TEST_LAT, TEST_LON, "2023-01-01", "2023-01-07")
#     print(f"Hourly rows: {len(df_h)}")
#     print(df_h.head())
#     print()
#     df_d = aggregate_to_daily(df_h)
#     print(f"Daily rows: {len(df_d)}")
#     print(df_d)
